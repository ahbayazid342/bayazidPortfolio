...
import hannanBhai from "../../assets/hannanbhai.jpg";
...
const testimonials = [
  {
    ...
    company: "Professor, Department of Computer Science and Engineering, Jahangirnagar University",
    feedback:
      "Bayazid is not only a dedicated student in my university courses but also a valued collaborator in our research. His keen understanding of complex topics, combined with his proactive approach to learning, has been evident both in the classroom and our research endeavors. Bayazid’s ability to apply theoretical knowledge to practical challenges and his teamwork skills have significantly enriched our work. I have no doubt that his talent and commitment will drive his continued success.",
    image: Mushfique_Sir,
  ...
  },
  {
    ...
    company: "Assistant Professor, Department of Computer Science and Engineering, Jahangirnagar University",
    feedback:
      "I have had the pleasure of supervising Ahsan Habib in competitive programming. He has participated in numerous international and national onsite and online contests, consistently showcasing exceptional problem-solving skills and a keen analytical mind. His dedication and performance in these competitions highlight his commitment and ability to excel in challenging environments. Bayazid is a standout student with a bright future ahead.",
    image: rafsan_sir,
  ...
  },
  {
    ...
    image: hannanBhai,
    link: "https://www.linkedin.com/in/hannanhossain/",
  },
  // Add more testimonials as needed
];

const brands = [
  { _id: "1", name: "Brand A", imgUrl: kaz },
          ...
          <div className="app__testimonial-item app__flex">
            ...
            <div className="app__testimonial-content">
              ...
              <div>
                ...
                <h5 className="p-text">Email: {testimonials[currentIndex].mail}</h5>
              </div>
            </div>
          </div>
...
export default AppWrap(MotionWrap(Testimonial, "app__testimonial"), "recommendation", "app__primarybg");
